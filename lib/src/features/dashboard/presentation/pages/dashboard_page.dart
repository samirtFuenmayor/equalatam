    ...
    return SingleChildScrollView(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        GridView.count(
          ...
          children: const [
            _KpiCard(title: 'Paquetes hoy',  value: '248',   delta: '+12%',
                positive: true,  icon: Icons.inventory_2_outlined,   color: Color(0xFF1A237E)),
            _KpiCard(title: 'En tránsito',   value: '1,832', delta: '+5%',
                positive: true,  icon: Icons.local_shipping_outlined, color: Color(0xFF01579B)),
            _KpiCard(title: 'Entregados',    value: '5,491', delta: '+18%',
                positive: true,  icon: Icons.check_circle_outline,    color: Color(0xFF2E7D32)),
            _KpiCard(title: 'Incidencias',   value: '14',    delta: '-3%',
                positive: false, icon: Icons.warning_amber_outlined,  color: Color(0xFFC62828)),
          ],
        ),
        const SizedBox(height: 24),
...
class _KpiCard extends StatelessWidget {
  ...
  const _KpiCard({required this.title, required this.value, required this.delta,
    required this.positive, required this.icon, required this.color});
            ...
            Container(
                ...
                child: Row(mainAxisSize: MainAxisSize.min, children: [
                  Icon(positive ? Icons.trending_up_rounded : Icons.trending_down_rounded,
                      size: 12,
                      color: positive ? const Color(0xFF2E7D32) : const Color(0xFFC62828)),
                  const SizedBox(width: 3),
                  Text(delta, style: TextStyle(fontSize: 11, fontWeight: FontWeight.w600,
                      color: positive ? const Color(0xFF2E7D32) : const Color(0xFFC62828))),
                ])),
          ]),
    ...
    return Container(
      ...
      child: Column(children: [
        Padding(
            ...
            child: Row(children: [
              const Text('Actividad reciente', style: TextStyle(
                  fontWeight: FontWeight.w600, fontSize: 15, color: Color(0xFF1A1A2E))),
              const Spacer(),
        ...
        ..._items.map((e) => Padding(
            ...
            child: Row(children: [
              Container(width: 36, height: 36,
                  decoration: BoxDecoration(color: e.$4.withOpacity(0.1),
                      borderRadius: BorderRadius.circular(10)),
                  child: Icon(e.$1, color: e.$4, size: 18)),
              const SizedBox(width: 12),
              Expanded(child: Text(e.$2,
                  style: const TextStyle(fontSize: 13, color: Color(0xFF374151)))),
              Text(e.$3, style: const TextStyle(fontSize: 11, color: Color(0xFF9CA3AF))),
            ]))),
        const SizedBox(height: 4),
      ]),
    );

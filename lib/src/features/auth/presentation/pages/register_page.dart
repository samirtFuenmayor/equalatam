...
class _RegisterContentState extends State<RegisterContent> {
  ...
  bool   _obscure = true;
  int    _step    = 0; // 0=Identificación 1=Datos 2=Seguridad 3=Afiliación
                      ...
                      return SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          child: loading
                              ...
                              : Text(
                              _step < 3 ? 'Siguiente' : 'Crear mi cuenta',
                              style: const TextStyle(
  ...
  Widget _stepContent() {
    switch (_step) {
      ...
      case 2: return _StepSeguridad(
          passCtrl: _passCtrl, confirmCtrl: _confirmCtrl,
          obscure: _obscure,
          onToggle: () => setState(() => _obscure = !_obscure));
      default: return _StepAfiliacion(
...
// ─── Indicador de pasos (ahora 4 pasos) ──────────────────────────────────────
class _StepIndicator extends StatelessWidget {
  final int current;
  const _StepIndicator({required this.current});

  static const _labels = ['Identificación', 'Datos', 'Seguridad', 'Familia'];
  static const _icons  = [
...
class _StepAfiliacion extends StatefulWidget {
  ...
  final void Function(String id, String nombre) onTitularEncontrado;
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      Container(
        ...
        child: const Row(children: [
          ...
          SizedBox(width: 10),
          Expanded(child: Text(
              'Si eres familiar o conocido de un cliente Equalatam, '
      ...
      // Formulario de afiliación (solo si quiere afiliarse)
      if (widget.quiereAfiliarse) ...[
        const SizedBox(height: 20),

        // Buscar titular por cédula
        ...
        Wrap(
          ...
          children: widget.parentescos.map((p) {
            final selected = p == widget.parentesco;
        ...
        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              ...
              TextFormField(
                ...
                decoration: _deco(hint: 'Juan Carlos',
        ...
        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              ...
              TextFormField(
                controller: apCtrl,
                textCapitalization: TextCapitalization.words,
                decoration: _deco(hint: 'Pérez López',
                    icon: Icons.person_outline),
                validator: (v) =>
                (v == null || v.trim().isEmpty) ? 'Requerido' : null,
              ),
        ...
        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              ...
              TextFormField(
                ...
                textCapitalization: TextCapitalization.words,
                decoration: _deco(
                    hint: 'Loja', icon: Icons.location_city_outlined),
              ),
            ])),
        const SizedBox(width: 12),
        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              ...
              TextFormField(
                controller: dirCtrl,
                decoration: _deco(
                    hint: 'Av. Principal...', icon: Icons.home_outlined),
              ),
            ])),
      ]),
    ]);
